...
public class TeamSystemWebAccessBrowserTest {
    ...
    @Test public void assertFileLink() throws Exception {
        ...
        changeSet.add(item);
        URL actual = browser.getFileLink(item);
        assertEquals("The file link was incorrect", "http://tswaserver:8090/_versionControl/changeset/99#path=%24%2FProject%2FFolder%2Ffile.cs&_a=contents", actual.toString());
    }
    ...
    @Test public void assertDiffLink() throws Exception {
        ...
        changeSet.add(item);
        URL actual = browser.getDiffLink(item);
        assertEquals("The diff link was incorrect", "http://tswaserver:8090/_versionControl/changeset/99#path=%24%2FProject%2FFolder%2Ffile.cs&_a=compare", actual.toString());
    }
